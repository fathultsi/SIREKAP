...
<?php $__env->startSection('DataTables'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('templates/plugins/datatables-bs4/css/dataTables.bootstrap4.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('templates/plugins/datatables-responsive/css/responsive.bootstrap4.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('templates/plugins/datatables-buttons/css/buttons.bootstrap4.min.css')); ?>">
    <!-- SweetAlert2 -->
    <link rel="stylesheet" href="<?php echo e(asset('templates/plugins/sweetalert2-theme-bootstrap-4/bootstrap-4.min.css')); ?>">
...
<?php $__env->startSection('content'); ?>
    ...
    <?php echo $__env->make('pages.rekap.modals', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('scripts_DataTables'); ?>
    ...
    <script src="<?php echo e(asset('templates/plugins/sweetalert2/sweetalert2.min.js')); ?>"></script>
    <script src="<?php echo e(asset('templates/plugins/Sheetjs/xlsx.full.min.js')); ?>"></script>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        ...
        function ExportZipUangMakan() {
            ...
            // $('#status').html('<span class="text-info">⏳ Memulai proses export...</span>');
            ...
            //             $.get('/export/status', function(data) {
            //                 if (data.status === 'done') {
            //                     clearInterval(interval);
            //                     $('#status').html(`
        ...
        //                 `);
            ...
            //                     clearInterval(interval);
            //                     $('#status').html(
            //                         '<span class="text-danger">❌ Gagal memproses export.</span>'
            //                     );
            //                 }
            //             });
            //         }, 5000);
            ...
            //     error: function() {
            //         $('#status').html(
            //             '<span class="text-danger">❌ Terjadi kesalahan saat mengirim request.</span>');
            //     }
            // });

            // $.ajax({
            //     url: '/exportRekapUangMakanZip', // 👈 Ganti ke route ZIP
            //     type: 'POST',
            //     data: JSON.stringify({
            //         data: hasilrekapuangmakan,
            //         bulanTahun: bulanTahun,
            ...
            //         const a = document.createElement('a');
            //         a.href = url;
            //         a.download = `Rekap_Uang_Makan_${bulanTahun}.zip`; // 👈 Nama file zip
            //         document.body.appendChild(a);
            //         a.click();
            //         window.URL.revokeObjectURL(url);
            //         a.remove();
            ...
            //             icon: 'error',
            //             title: 'Oops...',
            //             text: xhr.responseJSON?.message || 'Terjadi kesalahan saat mengunduh ZIP.',
            //         });
            //     }
            // });
        }
...
<?php echo $__env->make('layouts2.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\SIREKAP\resources\views/pages/rekap/index.blade.php ENDPATH**/ ?>